    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs overflow-y-auto">
      <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 my-8 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4 text-xs">
          ...
          {/* Submit Option */}
          <div className="rounded-xl bg-slate-50 p-3 border border-slate-100 dark:bg-slate-950 dark:border-slate-800 flex items-center gap-2">
            <input
              type="checkbox"
              id="submitApproval"
            ...
            />
            <label htmlFor="submitApproval" className="text-xs text-slate-700 dark:text-slate-300 cursor-pointer">
              Submit directly for management approval (<span className="font-semibold">PENDING_APPROVAL</span>)
            </label>
          </div>
