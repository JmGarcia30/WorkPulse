    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs">
      <div className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900 space-y-5 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="space-y-3 text-xs">
          ...
          {task.storageKey ? (
            <div className="flex items-center justify-between rounded-2xl border border-[#E8EAED] dark:border-slate-800 bg-[#F8F9FA] dark:bg-slate-950/30 p-3">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="rounded-xl bg-[#181A1C] p-2 text-white shrink-0">
                  <FileText className="h-4 w-4" />
                </div>
                <div className="min-w-0">
                  <p className="font-bold text-[#181A1C] dark:text-slate-100 truncate">
            ...
            <div className="rounded-2xl border border-dashed border-[#E8EAED] dark:border-slate-800 p-3 text-center text-[#9CA3AF]">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-bold text-[#181A1C] dark:text-slate-300">
            ...
            <textarea
              ...
              rows={2}
              className="w-full rounded-2xl border border-[#E8EAED] dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs text-[#181A1C] dark:text-slate-100 focus:border-[#181A1C] focus:outline-none"
            />
          </div>
        </div>
