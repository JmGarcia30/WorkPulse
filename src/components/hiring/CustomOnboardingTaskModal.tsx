        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#E8EAED] dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs text-[#181A1C] dark:text-slate-100 focus:border-[#181A1C] focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-2 pt-1">
            <input
              ...
              className="h-4 w-4 rounded border-[#E8EAED] text-[#181A1C] focus:ring-[#181A1C]"
            />
            <label
              htmlFor="isRequiredTask"
              className="text-xs text-[#181A1C] dark:text-slate-300 font-semibold cursor-pointer"
            >
              Required item (blocks Onboarding completion until verified/waived)
            </label>
          </div>

          <div className="flex items-center justify-end gap-2 pt-3 border-t border-[#E8EAED] dark:border-slate-800">
            <button
              type="button"
              onClick={onClose}
